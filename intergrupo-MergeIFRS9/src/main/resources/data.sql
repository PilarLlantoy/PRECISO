...
IF NOT EXISTS(SELECT * FROM preciso_administracion_vistas WHERE nombre = 'Ver Tipificaciones') BEGIN INSERT INTO preciso_administracion_vistas (nombre, ruta, unica,menu_principal,sub_menu_p1,sub_menu_p2) VALUES ('Ver Tipificaciones','/parametry/typification',1,'Parametría','Parametros Generales','Tipificaciones') END
...
IF NOT EXISTS(SELECT * FROM preciso_administracion_vistas WHERE nombre = 'Ver Maestro Inventarios') BEGIN INSERT INTO preciso_administracion_vistas (nombre, ruta, unica,menu_principal,sub_menu_p1,sub_menu_p2) VALUES ('Ver Maestro Inventarios','/parametric/masterinvent',1,'Parametría','Parametros Generales','Maestro Inventarios') END
...
IF NOT EXISTS(SELECT * FROM preciso_administracion_vistas WHERE nombre = 'Ver Cuadro Mando Cruce') BEGIN INSERT INTO preciso_administracion_vistas (nombre, ruta, unica,menu_principal,sub_menu_p1,sub_menu_p2) VALUES ('Ver Cuadro Mando Cruce','/parametric/cuadroMandoCru',1,'Procesos','Cruce Información','Cuadro Mando Cruce') END
IF NOT EXISTS(SELECT * FROM preciso_administracion_vistas WHERE nombre = 'Ver Cuadro Mando Conciliación') BEGIN INSERT INTO preciso_administracion_vistas (nombre, ruta, unica,menu_principal,sub_menu_p1,sub_menu_p2) VALUES ('Ver Cuadro Mando Conciliación','/parametric/cuadroMandoCons',1,'Procesos','Cuadro Mando','Cuadro Mando Conciliación') END
IF NOT EXISTS(SELECT * FROM preciso_administracion_vistas WHERE nombre = 'Ver Administración Conciliaciones') BEGIN INSERT INTO preciso_administracion_vistas (nombre, ruta, unica,menu_principal,sub_menu_p1,sub_menu_p2) VALUES ('Ver Administración Conciliaciones','/parametric/adminCons',1,'Procesos','Cuadro Mando','Administración Conciliaciones') END

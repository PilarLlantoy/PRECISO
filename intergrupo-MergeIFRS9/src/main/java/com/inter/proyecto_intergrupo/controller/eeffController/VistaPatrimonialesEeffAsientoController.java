...
@Controller
public class VistaPatrimonialesEeffAsientoController {
    ...
    @GetMapping(value = "/eeffConsolidated/EeffPatrimonialesAsiento")
    public ModelAndView showTemplatePatrimoniales(@RequestParam Map<String, Object> params) {
        ModelAndView modelAndView = new ModelAndView();
        Authentication auth = SecurityContextHolder.getContext().getAuthentication();
        User user = userService.findUserByUserName(auth.getName());

        if (userService.validateEndpoint(user.getUsuario(), "Ver EEFF Patrimoniales Asiento")) {
            ...
            List<tablaUnificadaEliminacionesPatrimoniales> list = eliminacionesPatrimonio.getDataPatrimonio(todayString, "Asiento de Eliminación");
            ...
            modelAndView.addObject("listaDeDatosAsiento", list);
            modelAndView.setViewName("eeffConsolidated/EeffPatrimonialesAsiento");
        } else {

...
public class VistaVerificationFilialesController {
    ...
    @GetMapping(value="/eeffConsolidated/SubsidiaryVerification")
    public ModelAndView showTemplateParametricConsolidated(@RequestParam Map<String, Object> params) {
        ...
        if(userService.validateEndpoint(user.getId(),"Ver EEFF Consolidado")) {
            ...
            modelAndView.setViewName("eeffConsolidated/SubsidiaryVerification");

            List<DatesLoadEeFF> eeffDataListVerificacion = datesLoadEeffService.getAllEeffConsolidatedVerificacion(todayString);

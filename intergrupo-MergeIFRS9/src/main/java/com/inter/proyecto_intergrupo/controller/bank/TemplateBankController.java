...
@Controller
public class TemplateBankController {
    ...
    @GetMapping(value="/bank/templateBank")
    ...
    @PostMapping(value="/bank/templateBank")
    public ModelAndView uploadFile(HttpServletRequest request, HttpServletResponse response,@RequestParam Map<String, Object> params){
        ModelAndView modelAndView = new ModelAndView("redirect:/bank/templateBank");
    ...
    @GetMapping(value = "/bank/templateBank/downloadReport")
    @ResponseBody
    ...
    @GetMapping(value = "/bank/templateBank/download")
    @ResponseBody
    ...
    @RequestMapping (value = "/bank/templateBank/sendIntergrupo")
    ...
    @GetMapping(value = "/bank/clearTemplate/{id}")
    @ResponseBody

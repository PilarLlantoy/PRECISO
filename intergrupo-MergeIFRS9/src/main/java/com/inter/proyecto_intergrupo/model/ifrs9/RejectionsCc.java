...
@NoArgsConstructor
@Entity
@Table(name = "nexco_rechazos_cc")
public class RejectionsCc {
    ...
    @Column(name = "segemento_proceso")
    private String segementoProceso;

    @Column(name = "stage_proceso")
    private String stageProceso;

    @Column(name = "tipo_rechazo_real")
    private String tipoRechazoReal;
}

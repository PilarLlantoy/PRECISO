...
public class CurrencyListReport {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Currency> currencyList;

    public CurrencyListReport(List<Currency> currencyList){
        this.currencyList = currencyList;
        workbook = new XSSFWorkbook();
    }

    private void writeHeaderLine(){
        sheet = workbook.createSheet("Divisa");
        ...
        createCell(row, 0, "Código Divisa", style);
        createCell(row, 1, "Nombre Divisa", style);
        createCell(row, 2, "Divisa Neocon", style);
    ...
    private void writeDataLines(){
        ...
        for(Currency currency: currencyList){
            ...
            createCell(row,columnCount++,currency.getNombre(),style);
            createCell(row,columnCount++,currency.getDivisaNeocon(),style);
        }
    }

...
public class ParamInformeNotasListReport {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<String[]> informeList;
    private List<ParamInformeNotas> listInforme;
    private static final long serialVersionUID = 1L;
    private static final int BYTES_DOWNLOAD = 1024;

    public ParamInformeNotasListReport(List<String[]> informeList, List<ParamInformeNotas> listInforme) {
    ...
    private void writeHeaderLine(){
        sheet = workbook.createSheet("Informe Notas");
    ...
    private void writeDataLines(){
        ...
        for(ParamInformeNotas paramInforme: listInforme){

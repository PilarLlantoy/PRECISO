...
public class ReconciliationDiffListReport {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Object[]> DiffList;

    public ReconciliationDiffListReport(List<Object[]> diffList, int i){
    ...
    private void writeHeaderLine(){
        ...
        createCell(row, 3, "Saldo Mes", style);
    ...
    private void writeDataLines(){
        ...
        for(Object[] difference: DiffList){
            ...
            createCell(row,columnCount++,Double.parseDouble(difference[3].toString()),style1);
            createCell(row,columnCount++,Double.parseDouble(difference[4].toString()) ,style1);
            createCell(row,columnCount++,Double.parseDouble(difference[5].toString()) ,style1);
        }
    }
    ...
    public void exportLog(HttpServletResponse response, ArrayList<String[]> lista) throws IOException
    {
        ...
        createCell(row1, 3, "Saldo Mes", style);
        createCell(row1, 4, "Valor", style);
        createCell(row1, 5, "Diferencia", style);

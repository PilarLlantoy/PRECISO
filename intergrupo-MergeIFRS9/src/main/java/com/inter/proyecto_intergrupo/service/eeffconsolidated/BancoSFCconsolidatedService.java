...
@Service
@Transactional
public class BancoSFCconsolidatedService {
    ...
    public boolean ValidarFechaBanco(InputStream fileContent, String periodo) {
        try {

            String outputPath = "C:\\Users\\CE66916\\Documents\\BBVA Intergrupo\\SoporteSFCValores.pt";

            InputStreamReader inputStreamReader = new InputStreamReader(fileContent);
            BufferedReader bufferedReader = new BufferedReader(inputStreamReader);

            // Crear un flujo de salida para escribir en el archivo de salida

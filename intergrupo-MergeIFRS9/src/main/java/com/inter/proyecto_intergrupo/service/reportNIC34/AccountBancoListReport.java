...
public class AccountBancoListReport {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<String[]> accountList;
    private List<AccountBanco> listAccount;
    private static final long serialVersionUID = 1L;
    private static final int BYTES_DOWNLOAD = 1024;

    public AccountBancoListReport(List<String[]> accountList, List<AccountBanco> listAccount) {
    ...
    private void writeHeaderLine(){
        sheet = workbook.createSheet("Naturaleza Plantilla");
        ...
        createCell(row, 1, "Naturaleza", style);
    }
    ...
    private void writeDataLines(){
        ...
        for(AccountBanco accountBanco: listAccount){
            Row row = sheet.createRow(rowCount++);
            int columnCount = 0;
            createCell(row,columnCount++,accountBanco.getCuenta(),style);
            createCell(row,columnCount++,accountBanco.getNaturaleza(),style);
        }
    }

...
public class ParamNIC34ListReport {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<String[]> nic34List;
    private List<ParamNIC34> listNic34;
    private static final long serialVersionUID = 1L;
    private static final int BYTES_DOWNLOAD = 1024;

    public ParamNIC34ListReport(List<String[]> nic34List, List<ParamNIC34> listNic34) {
    ...
    private void writeDataLines(){
        ...
        for(ParamNIC34 paramNIC34: listNic34){
